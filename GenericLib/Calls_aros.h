...
{								\
    struct Library   *LibBase;					\
								\
    inline struct Library* _GetLibBase()			\
    {								\
	return LibBase;						\
    }								\
...
#define BEGINDECL(name, libname)				\
	...
	{							\
	    ...
	    if (pBase == 0)					\
	    {							\
		pBase = Exec->OpenLibrary("Libs/" libname, version);\
		if (pBase == 0)					\
		    return 0;					\
	    }							\
...
#define FUNC0(type, name, off) \
    type name()                                     \
    {                                               \
	return AROS_LVO_CALL0(type, struct Library*, LibBase, off,0);\
    }

#define FUNC1(type, name,off,type1,parm1,reg1)  \
    type name(type1 parm1)                          \
    {                                               \
	return AROS_LVO_CALL1(type, AROS_LCA(type1, parm1, reg1), struct Library*, LibBase, off,0);\
    }

#define FUNC2(type, name,off,type1,parm1,reg1,type2,parm2,reg2)  \
    type name(type1 parm1, type2 parm2)             \
    {                                               \
	return AROS_LVO_CALL2(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), struct Library*, LibBase, off,0);\
    }
...
#define FUNC3(type, name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3) \
    ...
    {                                               \
	return AROS_LVO_CALL3(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), struct Library*, LibBase, off,0);\
    }
...
#define FUNC4(type,name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3,type4,parm4,reg4) \
    ...
    {                                               \
	return AROS_LVO_CALL4(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), AROS_LCA(type4, parm4, reg4), struct Library*, LibBase, off,0);\
    }
...
#define FUNC5(type, name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3,type4,parm4,reg4,type5,parm5,reg5) \
    ...
    {                                               \
	return AROS_LVO_CALL5(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), AROS_LCA(type4, parm4, reg4), AROS_LCA(type5, parm5, reg5), struct Library*, LibBase, off,0);\
    }
...
#define FUNC6(type, name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3,type4,parm4,reg4,type5,parm5,reg5,type6,parm6,reg6) \
    ...
    {                                               \
	return AROS_LVO_CALL6(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), AROS_LCA(type4, parm4, reg4), AROS_LCA(type5, parm5, reg5), AROS_LCA(type6, parm6, reg6), struct Library*, LibBase, off,0);\
    }
...
#define FUNC7(type,name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3,type4,parm4,reg4,type5,parm5,reg5,type6,parm6,reg6,type7,parm7,reg7) \
    ...
    {                                               \
	return AROS_LVO_CALL7(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), AROS_LCA(type4, parm4, reg4), AROS_LCA(type5, parm5, reg5), AROS_LCA(type6, parm6, reg6), AROS_LCA(type7, parm7, reg7), struct Library*, LibBase, off,0);\
    }
...
#define FUNC8(type,name,off,type1,parm1,reg1,type2,parm2,reg2,type3,parm3,reg3,type4,parm4,reg4,type5,parm5,reg5,type6,parm6,reg6,type7,parm7,reg7,type8,parm8,reg8) \
    ...
    {                                               \
	return AROS_LVO_CALL8(type, AROS_LCA(type1, parm1, reg1), AROS_LCA(type2, parm2, reg2), AROS_LCA(type3, parm3, reg3), AROS_LCA(type4, parm4, reg4), AROS_LCA(type5, parm5, reg5), AROS_LCA(type6, parm6, reg6), AROS_LCA(type7, parm7, reg7), AROS_LCA(type8, parm8, reg8), struct Library*, LibBase, off,0);\
    }
